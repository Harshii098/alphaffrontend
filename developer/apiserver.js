...
function editDatacall(id) {
    ...
    fetch("http://35.91.148.85:8080/server/" + id, {
        method: "GET",
        mode: "cors",
...
function addServer() {
    ...
    fetch("http://35.91.148.85:8080/postserver", {
    ...
    http.open('POST','http://35.91.148.85:8080/postmobile');
...
function editData() {
    ...
    fetch("http://35.91.148.85:8080/putserver",  {
...
function getData() {
    fetch("http://35.91.148.85:8080/server").then(
        (res) => res.json()
    ).then((response) => {
        var tmpData = "";
