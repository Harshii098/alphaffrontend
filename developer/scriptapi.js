...
let httpm=null;
let url='http://35.91.148.85:8080/mobile';
...
editBtn.onclick =function(){
    ...
    clearForm();
    form.classList.add('active')
    //fetch("http://35.91.148.85:8080/mobile/" +serial_number, {
...
saveBtn.onclick=function(){
    ...
    fetch("http://35.91.148.85:8080/mobile",{
...
/*fetch("http://35.91.148.85:8080/mobile").then(
    (res) => res.json()
).then((response) => {
    var tmpData = "";
...
function onEdit() {
        ...
        fetch("http://35.91.148.85:8080/putmobile", {
...
function editDatacall(id) {
    ...
    fetch("http://35.91.148.85:8080/mobile/" + id, {
        method: "GET",
        mode: "cors",
    }).then((res) => res.json()).then((response) => {
        console.log("Edit info", response);
...
function addMobile() {
    ...
    let payload = getFormData();
     fetch("http://35.91.148.85:8080/postmobile", {
